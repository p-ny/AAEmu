...
public enum SpecialType
{
    ...
    ItemSmelting = 151,
    ReduceCooldown = 153,
    FamilyLevelChange = 154,
    MakeCraftOrderSheet = 155,
    RestoreDisableEnchant = 156,
    ChangeBuffToleranceStep = 157,
    ChargeCooldown = 158,
    RestoreCraftOrderSheet = 159,
    ProcessCraftOrder = 160,
    EquipSlotReinforceAddExp = 161,
    BlessUthstinSelectPage = 162,
    EquipSlotReinforceChangeLevelEffect = 163,
    RechargeItemProcLifetime = 164,
    ItemChangeMapping = 165,
    ChangeChargeSkillCount = 166,
    ChangeChargeCooldown = 167,
    ProcessCraftOrderInstant = 168,
    ItemSocketChange = 169,
    ZoneConflictChange = 170,
    TeamSummon = 171,
    MoveToSavedPos = 172,
    Ensemble = 173,
    EnsembleSuggest = 174,
    GiveLeadershipPoint = 175,
    ReduceBuffTime = 176,
    GiveFactionCompetitionPoint = 177,
    AddArchePassPoint = 178,
    ResetFactionChangeCooldown = 179,
    BuyPremium = 180,
    ChangeZoneScore = 181,
    TeleportToIntegrationWorld = 182,
    ItemElement = 183,
    ZonePermissionCheck = 184,
    ButlerProductionCostCharge = 185,
    ButlerAddExp = 186,
    ItemEvolvingSelectReRoll = 187,
    BindFactionRezDistrict = 188,
    ChangeVisualRace = 189,
    ChangeVisualRaceExpiredTime = 190,
    SaveExpeditionPortal = 191,
    TeleportExpeditionPortal = 192,
