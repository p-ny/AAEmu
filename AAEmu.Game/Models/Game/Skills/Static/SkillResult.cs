...
public enum SkillResultKeys
{
    ...
    skill_urk_dominion_member_at_pos,
    skill_urk_dominion_member_at_pos_not,
    skill_urk_housing,
...
public static class SkillResultHelper
{
    ...
    public static SkillResult SkillResultErrorKeyToId(SkillResultKeys key)
    {
        return key switch
        {
            ...
            SkillResultKeys.skill_urk_dominion_member_at_pos => SkillResult.UrkDominionMemberAtPos,
            SkillResultKeys.skill_urk_dominion_member_at_pos_not => SkillResult.UrkDominionMemberAtPosNot,
